...
async function getAccessToken() {
  const consumer_key = "WWdopeIsNkukhjAsTcBA5cJjjW1QBOXw"; // REPLACE IT WITH YOUR CONSUMER KEY
  const consumer_secret = "lfOhH9N5mBZwKiG8"; // REPLACE IT WITH YOUR CONSUMER SECRET
  const url =
...
app.get("/", (req, res) => {
  res.send("MPESA DARAJA API WITH NODE JS Fusion-Xe");
